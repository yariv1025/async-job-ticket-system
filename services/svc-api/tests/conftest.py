...
def ssm_parameters():
    ...
    with mock_ssm():
        ...
        ssm.put_parameter(Name="/jobsys/test/dynamodb/table-name", Value="Jobs", Type="String")
        ssm.put_parameter(
            Name="/jobsys/test/sqs/queue-url",
            Value="http://localhost:4566/000000000000/jobs-queue",
            Type="String",
        )
        yield ssm
